...
const Stats = () =>  (
  ...
  {stats.map((stat) => (
    <div
      key={stat.id}
      className="flex-1 flex items-center justify-center md:justify-start flex-row m-9 min-w-[200px]"
    >
      <CountUp
      from={0}
      to={stat.value}
      ...
      direction="up"
      duration={0.5}
      className="count-up-text font-poppins font-semibold text-[26px] sm:text-[32px] md:text-[36px] lg:text-[40px] leading-[36px] sm:leading-[42px] lg:leading-[53px] text-white mr-3"
/>
