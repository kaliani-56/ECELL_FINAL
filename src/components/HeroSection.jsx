    ...
    <div className="bg-transparent w-full px-0 lg:mt-5">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between h-screen overflow-visible">
        ...
        <div className="w-full lg:w-1/2 flex flex-col lg:text-left lg:-mt-40  lg:translate-x-[-80px] sm:mb-40 ">
          ...
          <TextType 
  text={["The Entrepreneurship Cell at NSUT fuels bold ideas, fearless creativity and disruptive thinking. We challenge every student to dream big, act smart, and build what the world needs next. It’s time to play the game where innovation is the only winning move."]}
  typingSpeed={20}
  pauseDuration={1500}
  showCursor={true}
  cursorCharacter="|"
